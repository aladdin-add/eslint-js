...
## [8.5.0](https://github.com/aladdin-add/eslint-js/compare/eslint-scope-v8.4.0...eslint-scope-v8.5.0) (2025-09-13)


### Features

* Add support for ES2026 `using` and `await using` declarations ([#658](https://github.com/aladdin-add/eslint-js/issues/658)) ([39e0865](https://github.com/aladdin-add/eslint-js/commit/39e086509a0164dcea960719fb9673c73452f36e))
...
* add the `eslint-scope` package ([#615](https://github.com/aladdin-add/eslint-js/issues/615)) ([2ecfb8b](https://github.com/aladdin-add/eslint-js/commit/2ecfb8ba460a73601b859fd10d000cee817d170c))
* Option to track JSX components as references ([#646](https://github.com/aladdin-add/eslint-js/issues/646)) ([6dd3cbc](https://github.com/aladdin-add/eslint-js/commit/6dd3cbc2aaa285736eb668e4763a6c1d58f0fb59))


### Bug Fixes

* Remove node:assert dependency ([#633](https://github.com/aladdin-add/eslint-js/issues/633)) ([433a89d](https://github.com/aladdin-add/eslint-js/commit/433a89d18f556658751feb63f87303ebbf7b7cb7))
...
* update links to `eslint/js` repo ([#619](https://github.com/aladdin-add/eslint-js/issues/619)) ([956389a](https://github.com/aladdin-add/eslint-js/commit/956389ac150bd2394bc78a35c2a1f9d794f61ea8))
